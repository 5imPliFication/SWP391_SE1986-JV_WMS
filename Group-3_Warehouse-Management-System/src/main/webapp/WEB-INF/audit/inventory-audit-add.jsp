    ...
    <table class="table table-bordered table-hover">
        ...
        <c:forEach items="${products}" var="product">
            <tr>
                ...
                <td>${product.chip.name}</td>
                <td>${product.ram.size}</td>
                <td>${product.storage.size}</td>
                ...
                <table class="table table-bordered table-hover table-sm">
                    ...
                    <c:forEach items="${tmpInventoryAuditItems}" var="item" varStatus="status">
                        <tr>
                            ...
                            <td class="align-middle">${item.product.model.name}</td>
                            <td class="align-middle">${item.product.chip.name}</td>
                            <td class="align-middle">${item.product.ram.size}</td>
                            <td class="align-middle">${item.product.storage.size}</td>
                            <td class="align-middle">${item.product.size.size}</td>
