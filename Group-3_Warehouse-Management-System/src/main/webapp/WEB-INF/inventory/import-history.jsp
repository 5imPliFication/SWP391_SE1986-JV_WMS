    ...
    <body>
        ...
        <main class="main-content">
            ...
            <div class="d-flex align-items-center mb-3">
                <form class="form-inline" action="${pageContext.request.contextPath}/import-history"
                      method="get">
                        ...
                        <c:when test="${not empty goodsReceipts}">
                            <c:forEach items="${goodsReceipts}" var="goodsReceipt">
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <a href="${pageContext.request.contextPath}/import-history?action=detail&id=${goodsReceipt.id}"
                ...
                <nav class="mt-3">
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item ${pageNo == 1 ? 'disabled' : ''}">
                            <a class="page-link"
                               href="${pageContext.request.contextPath}/import-history?pageNo=${pageNo - 1}&receiptCode=${receiptCode}&fromDate=${fromDate}&toDate=${toDate}">
                                Previous
                            </a>
                        </li>
                            ...
                            <c:choose>
                                ...
                                <c:when test="${i == 1}">
                                    <li class="page-item ${i == pageNo ? 'active' : ''}">
                                        <a class="page-link"
                                           href="${pageContext.request.contextPath}/import-history?pageNo=${i}&receiptCode=${receiptCode}&fromDate=${fromDate}&toDate=${toDate}">
                                            ${i}
                                        </a>
                                    </li>
                                </c:when>
