...
<main class="main-content">
    ...
    <div class="panel">
        ...
        <div class="report-type-group">
            <a class="report-type" href="${pageContext.request.contextPath}/report?type=inventory&view=in-out-stock&year=${year}&month=${month}">In-Out-Stock</a>
            ...
            <nav class="mt-3">
                <ul class="pagination justify-content-center">
                    <li class="page-item ${pageNo == 1 ? 'disabled' : ''}">
                        <a class="page-link"
                           href="${pageContext.request.contextPath}/report?type=export&year=${year}&month=${month}&pageNo=${pageNo - 1}">
                            Previous
                        </a>
                    </li>
                        ...
                        <c:choose>
                            <c:when test="${i == 1 || i == totalPages || (i >= left && i <= right)}">
                                <li class="page-item ${i == pageNo ? 'active' : ''}">
                                    <a class="page-link"
                                       href="${pageContext.request.contextPath}/report?type=export&year=${year}&month=${month}&pageNo=${i}">
                                        ${i}
                                    </a>
                                </li>
                            </c:when>
